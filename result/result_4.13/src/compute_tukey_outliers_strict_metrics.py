...
def main() -> None:
    ...
    ap.add_argument("--tukey", type=Path, default=root / "tukey_fence_eval.csv")
    ap.add_argument(
        "--out",
        type=Path,
        default=None,
    ...
    ap.add_argument(
        ...
        type=Path,
        default=None,
        help="Loose metrics CSV (default: <tukey_dir>/tukey_outliers_loose_recall_precision.csv)",
    )
    args = ap.parse_args()
    strict_out = args.out or (args.tukey.parent / "tukey_outliers_strict_recall_precision.csv")
