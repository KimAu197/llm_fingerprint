...
def norm_name(c):  # 统一列名：小写、去非字母数字
...
def main():
    ...
    ap.add_argument("--overall-col", type=str, default=None,
                    help="显式指定总体分数列名（例如 'overal score' 或 'overall_score'）。")
